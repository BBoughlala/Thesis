...
def main():
    ...
    results = pd.DataFrame(results, columns=["Custom", "SK", "Custom Depth", "SK Depth"])
    results.to_csv("mnar_y_results.csv", index=False)
